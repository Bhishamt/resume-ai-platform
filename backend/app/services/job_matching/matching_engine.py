...
class MatchingEngine:
    ...
    def match_resume_to_job(
        ...
        skill_res = SkillMatcher.match_skills(resume_text, required_skills, preferred_skills)
        
        # 2. Run Keyword Matcher (20% weight)
        keyword_res = KeywordMatcher.match_keywords(resume_text, job_title, job_description)
        
        # 3. Run Experience Matcher (20% weight)
        exp_res = ExperienceMatcher.match_experience(resume_text, required_experience, job_title)
        ...
        similarity_val = SimilarityEngine.calculate_similarity(resume_text, job_description)
        sim_score, sim_weighted, sim_reasons = ScoreCalculator.calculate_similarity_score(similarity_val)
