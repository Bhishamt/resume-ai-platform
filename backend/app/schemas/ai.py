...
class AIReviewRequest(BaseModel):
    ...
    analysis_id: Optional[UUID] = Field(None, description="Optional ID of a specific analysis report")

class AICoverLetterRequest(BaseModel):
    resume_id: UUID = Field(..., description="ID of the resume")
    job_description_id: Optional[UUID] = Field(None, description="Optional ID of job description to match against")
    ...
    job_text: Optional[str] = Field(None, description="Optional raw text of the job description")
...
class AIInterviewRequest(BaseModel):
    resume_id: UUID = Field(..., description="ID of the resume")
    job_description_id: Optional[UUID] = Field(None, description="Optional ID of job description")
