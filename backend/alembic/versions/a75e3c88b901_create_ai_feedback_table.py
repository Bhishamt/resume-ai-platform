...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['analysis_id'], ['analysis_reports.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['job_match_id'], ['job_matches.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_ai_feedback_analysis_id'), 'ai_feedback', ['analysis_id'], unique=False)
    op.create_index(op.f('ix_ai_feedback_job_match_id'), 'ai_feedback', ['job_match_id'], unique=False)
